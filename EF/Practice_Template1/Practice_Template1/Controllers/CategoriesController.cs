...
namespace Practice_Template1.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(Practice_Template1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Category != null ? 
                          ...
                          Problem("Entity set 'Practice_Template1Context.Category'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Practice_Template1Context.Category'  is null.");
            }
            var category = await _context.Category.FindAsync(id);
            if (category != null)
            {
